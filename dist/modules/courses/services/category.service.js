...
class CategoryService {
    ...
    async getAllCategories(includeInactive = false) {
        ...
        // Cache for 1 hour
        await (0, cache_1.setCache)(cacheKey, result, cache_1.CACHE_TTL.MEDIUM);
        return result;
    }
    /**
    ...
    async createCategory(data) {
        ...
        // Invalidate cache
        await (0, cache_1.deleteCachePattern)('categories:*');
        return {
            id: category.id,
            name: category.name,
            slug: category.slug,
    ...
    async updateCategory(id, data) {
        ...
        if (data.slug && data.slug !== existing.slug) {
            const slugExists = await prisma_1.prisma.category.findUnique({
