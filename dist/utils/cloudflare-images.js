...
exports.isCloudflareImagesConfigured = isCloudflareImagesConfigured;
exports.uploadImageToCloudflareImages = uploadImageToCloudflareImages;
exports.deleteCloudflareImage = deleteCloudflareImage;
const accountId = process.env.CLOUDFLARE_ACCOUNT_ID;
const apiToken = process.env.CLOUDFLARE_API_TOKEN;
function isCloudflareImagesConfigured() {
    return Boolean(accountId && apiToken);
}
async function uploadImageToCloudflareImages(file, filename, contentType) {
