...
export class RealtimeService {
  ...
  private setupEventHandlers() {
    this.io.on('connection', (socket) => {
      ...
      socket.on('join_whiteboard', (data: { whiteboardId: string }) => {
      ...
      socket.on('leave_whiteboard', (data: { whiteboardId: string }) => {
        const { whiteboardId } = data;
      ...
      socket.on('whiteboard_clear', (data: { whiteboardId: string; userId: string }) => {
